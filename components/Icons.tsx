...
export const BrainCircuitIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.5 13.5c1.5-1.5 5.5-1.5 7 0m-7 0v2.5m7-2.5v2.5m-7-2.5h-1a2 2 0 00-2 2v1a2 2 0 002 2h1m7-2.5h1a2 2 0 012 2v1a2 2 0 01-2 2h-1m-7-13.5v1m0 0V8m0 0a2.5 2.5 0 100-5 2.5 2.5 0 000 5zm7 0v1m0 0V8m0 0a2.5 2.5 0 100-5 2.5 2.5 0 000 5zm-7 0h7" />
    </svg>
);
...
export const GitCommitIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11 16.5A4.5 4.5 0 1111 7.5a4.5 4.5 0 010 9zm0 0V21m0-13.5V3M4.5 12H3m18 0h-1.5" />
    </svg>
);